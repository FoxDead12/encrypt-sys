var i=Object.defineProperty;var l=(a,o,t)=>o in a?i(a,o,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[o]=t;var e=(a,o,t)=>(l(a,typeof o!="symbol"?o+"":o,t),t);import{s as n,i as d,x as s}from"../../lit-element.js";class r extends n{constructor(){super(),this.hash=null,this.salt=null,this.show=!1}render(){return s`
      ...
      ${this.hash?s`
        ...
        `:""}
    `}firstUpdated(){this.button=this.shadowRoot.getElementById("button")}async generateHash(){this.button.setAttribute("disabled",!0);try{var o=await app.execute_request("/salt","POST",{data:this.shadowRoot.getElementById("data").value,salt:this.show?this.shadowRoot.getElementById("salt").value:null});o=JSON.parse(o),this.hash=o.hash,this.salt=o.salt}catch(t){console.error(t)}this.button.removeAttribute("disabled")}}e(r,"properties",{hash:{type:String},salt:{type:String},show:{type:Boolean}}),e(r,"styles",d`
  ...
  `);customElements.define("salt-page-comp",r);
