...
export class AsysEncryptPageComp extends LitElement {
  ...
  async encrypt (e) {
    ...
    try {
      ...
      var result = await app.execute_request("/asy-encrypt", "POST", {
  ...
  async decrypt (e) {
    ...
    try {
      ...
      var result = await app.execute_request("/asy-decrypt", "POST", {
...
customElements.define('asys-encrypt-page-comp', AsysEncryptPageComp)
